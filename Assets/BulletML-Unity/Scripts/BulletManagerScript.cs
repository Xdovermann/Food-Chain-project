...
namespace FoodChain.BulletML
{
  ...
  public class BulletManagerScript : MonoBehaviour, BulletMLLib.IBulletManager
  {
    ...
    /// </summary>
    public event System.Action<GameObject> OnBulletDestroyed;
    ...
    void BulletSpawnedHandler(BulletObject bullet, string bulletName,BulletSourceScript Emitter)
    {
      ...
      {
              //  Debug.LogError("createn we een neiuwe bullet");
            ...
            if(bulletScript != null)
            {
             ...
             //   else
              //  {
               //     Debug.LogError("passing emitter is null ");
               // }


                //// Change sprite if the field has been filled      // Look in the bank
                //if (bankEntry.sprite != null)
                //{
                //    SpriteRenderer spriteRenderer = bulletScript.GetComponentInChildren<SpriteRenderer>();
    ...
    public void RemoveBullet(BulletMLLib.Bullet deadBullet)
    {
      ...
      {
        OnBulletDestroyed(GetGameObjectFromBullet(deadBullet));
        return;
      }
